...
const KEYWORDS = [
  ...
  // Kwong / COVID Penalty Refunds — pillar page (/irs-covid-penalty-refund-kwong)
  "Kwong IRS penalty refund",
  "Kwong v United States penalty refund",
  "Kwong case IRS refund claim",
  "COVID penalty refund IRS",
  "COVID era IRS penalty refund 2026",
  "IRS refund penalties 2020 2023",
  "section 7508A d penalty refund",
  "IRC 7508A COVID disaster postponement",
  "COVID disaster period tax deadline postponed",
  "IRS penalties disaster period refund",
  "failure to file penalty refund COVID",
  "failure to pay penalty refund COVID",
  "estimated tax penalty refund COVID",
  "international information return penalty Kwong",
  "Form 843 Kwong claim",
  "Form 843 COVID penalty refund",
  "how to file Form 843 protective claim",
  "protective refund claim Kwong case",
  "protective claim for refund IRS how to",
  "Form 843 protective claim wording",
  "IRS transcript codes penalty 166 276",
  "how much COVID penalties did I pay transcript",
  // Kwong — missed deadline page (/missed-july-10-kwong-deadline)
  "missed July 10 IRS deadline",
  "missed July 10 2026 Kwong deadline",
  "Kwong deadline passed what now",
  "is it too late to file Kwong claim",
  "COVID penalty refund deadline missed",
  "Kwong claim after deadline",
  "2 years from payment refund claim IRS",
  "IRC 6511 two year payment rule",
  "refund statute expiration date RSED payment",
  "installment agreement payments refund claim Kwong",
  "Form 843 postmark deadline certified mail",
  "timely mailing timely filing 7502 refund claim",
  "IRS extend Kwong deadline",
  "Kwong protective claim late",
  "abatement unpaid COVID penalties Kwong",
]
